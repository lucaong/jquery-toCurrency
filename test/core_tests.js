$(document).ready(function() {
  test('$.toCurrency', function() {
    ...
    equal($.toCurrency("123456.123"), "&euro; 123,456.12", "it should not put a delimiter in front of a number");
    ...
    raises(function() { $.toCurrency("abc") }, "it should throw an exception if input is invalid");
  });
